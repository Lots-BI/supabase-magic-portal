// Lots BI · AreaChartLots
// Chart de evolução temporal com gradientes Lots BI, eixos sutis, tooltip glass.
...
export function AreaChartLots({ data, series, height = 260, className, yMetric }: Props) {
  ...
  return (
    <div
      ...
      style={{ height: `clamp(176px, 38vw, ${height}px)` }}
    >
