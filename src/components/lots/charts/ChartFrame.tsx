...
export function ChartFrame({
  ...
  return (
    <section className={cn("lots-surface relative isolate z-0 overflow-hidden", className)}>
      <header className="flex flex-col gap-3 border-b border-border bg-muted/55 px-4 py-4 sm:flex-row sm:items-start sm:justify-between sm:px-5">
      ...
      {legend && (
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 border-b border-border bg-muted/70 px-4 py-2 sm:px-5">
          {legend}
        </div>
      )}
      <div
