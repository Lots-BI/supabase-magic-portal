  ...
  return (
    <div className="space-y-7 pb-10">
      <PageHeader
        ...
        actions={
          <Button asChild className="lots-focus">
      ...
      <SectionCard title="Catálogo de plataformas">
        <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 xl:grid-cols-3">
          {catalog.map((p) => (
            <div
              key={p.key}
              className="lots-surface rounded-xl border border-border p-4 transition-shadow hover:shadow-sm"
            >
              ...
              <Button asChild size="sm" className="mt-3 w-full lots-focus" variant="outline">
