-- Jobs de publicação usam service_role (auth.uid() é null).
-- O guard de cliente tratava isso como JWT de cliente e barrava
-- status=publicado / published_at depois do Graph já ter postado.
